...
export default function NestingDemo() {
    return (
        <div className="why-sass__demo-nesting">
            <div className="why-sass__demo-nesting__container">
                <div className="why-sass__demo-nesting__card">
                    <div className="why-sass__demo-nesting__card__icon-box">
                        <div className="why-sass__demo-nesting__card__icon-box--container">
                            <svg viewBox="0 0 512 512" width="100" title="thumbs-up">
                    ...
                    <h3 className="why-sass__demo-nesting__card__title">Una frase pegajosa</h3>
                    <p className="why-sass__demo-nesting__card__text">
                        Lorem ipsum dolor sit amet consectetur, adipisicing elit. Explicabo similique incidunt eveniet qui doloremque praesentium soluta architecto quos. Fugiat minus doloremque voluptate eaque! Quasi dicta ipsam et distinctio sit facere.
                    </p>
                </div>
            </div>
            <ButtonBox>
                <Button onClick={() => window.open('https://codepen.io/paulmirve/pen/NWggxEb', '_blank').focus()}>Ver código</Button>
            </ButtonBox>
        </div>
    )
}
